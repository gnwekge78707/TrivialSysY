...
public class StmtParser extends ParserBase {
    ...
    private void parseLVal(Tokenizer tokenizer) {
        ...
        //fixme: parsing lVal twice, handle the same error twice...
        //TODO: check for sure if parseLVAL will change anything about symbolTable, ErrorBuffer, OutputBuffer etc...
        //FIXME: this is huge
        updateToken();

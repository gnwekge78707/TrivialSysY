...
public class Tokenizer {
    ...
    LinkedList<LinkedList<Error>> errorsCheckpoints = new LinkedList<>();
    ...
    public void putCheckpoint() {
        ...
        errorsCheckpoints.add(ErrorBuffer.getInstance().getErrors());
    }
    ...
    public void restoreCheckpoint() {
        ...
        ErrorBuffer.getInstance().replaceErrors(errorsCheckpoints.pollLast());
    }
    // -------------- support for checkpoints -----------------
